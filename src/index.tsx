...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  ...
  return class StaffbaseExampleRenderWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): StaffbaseExampleRenderWidgetProps {
      const attrs = this.parseAttributes<StaffbaseExampleRenderWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<StaffbaseExampleRenderWidget {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "staffbase-example-render-widget",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Staffbase Example Render Widget',
    iconUrl: icon
};
